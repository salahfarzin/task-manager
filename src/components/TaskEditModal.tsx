...
import { X, Save, Calendar, Paperclip, User, Trash2, Bot, ChevronDown, ChevronUp, GitBranch, FileCode, Sparkles, CheckCircle, XCircle, ClipboardList, Code2, ShieldCheck, Briefcase } from 'lucide-react';
...
const AiPipelineResults: React.FC<AiPipelineResultsProps> = ({ task }) => {
  const { t } = useTranslation();
